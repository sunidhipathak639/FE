...
export default function RegisterForm() {
  ...
  const onSubmit = (data: RegisterData) => {
    ...
    // If there are validation errors, collect them and show in a toast
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <CardContent className="px-6 grid gap-4 space-y-5">
            ...
            <div className="grid gap-2 relative">
              ...
              <Input
                className={`border !text-white ${errors.name ? "border-rose-500" : ""}`}
                id="name"
                {...register("name")}
              />
              {errors.name && (
                <p className="text-rose-500 text-sm mt-1 absolute -bottom-6.5 text-left font-extralight">
                  {errors.name.message}
                </p>
              )}
            </div>
            ...
            <div className="grid gap-2 relative">
              ...
              <Input
                className={`border !text-white ${errors.email ? "border-rose-500" : ""}`}
                id="email"
                type="email"
                {...register("email")}
              />
            ...
            <div className="grid gap-2 relative">
              ...
              <Input
                className={`border ${errors.password ? "border-rose-500" : ""}`}
                id="password"
                type="password"
                {...register("password")}
              />
          ...
          <CardFooter className="flex flex-col px-6 gap-3 mt-4 text-white">
